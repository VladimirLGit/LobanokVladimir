...
public class PcDao implements IPc<PC,Integer> {
    ...
    @Override
    public void delete(PC item) throws NotExistObject {
    ...
    @Override
    public void update(PC item) throws NotExistObject {
